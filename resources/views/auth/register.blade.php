                    ...
                    <div class="row g-0 align-items-stretch">
                        <div class="col-lg-5 d-none d-lg-flex hero-panel">
                            <div class="hero-content">
                                <span class="badge text-uppercase">Start Strong</span>
                                <h2>Set up your COBIT workspace with confidence</h2>
                                <p>Capture organization context, map stakeholder roles, and unlock tailored guidance from day one.</p>
                                <ul>
                                    <li><i class="fas fa-check-circle"></i>Role-based insights and collaboration</li>
                                    <li><i class="fas fa-check-circle"></i>Automated maturity scorecards</li>
                                    <li><i class="fas fa-check-circle"></i>Guided remediation actions</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-7 form-panel">
                            <div class="form-heading">
                                ...
                                <p>Complete your profile to personalize the assessment experience.</p>
                            </div>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <input id="organisasi" type="text" class="form-control @error('organisasi') is-invalid @enderror" name="organisasi" value="{{ old('organisasi') }}" required placeholder="Your organization name">
                                        </div>
                                        @error('organisasi')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <select id="jabatan" name="jabatan" class="form-select @error('jabatan') is-invalid @enderror" required>
                                                <option value="" disabled {{ old('jabatan') ? '' : 'selected' }}>-- Select Your Position --</option>
