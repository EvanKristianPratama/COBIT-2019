...
@section('content')
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="card shadow-sm mb-4 hero-card" style="border:none;box-shadow:0 22px 45px rgba(14,33,70,0.15);">
            <div class="card-header hero-header py-4"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="hero-title" style="font-size:1.5rem;font-weight:700;letter-spacing:0.04em;">Evidence
                            Library</div>
                    ...
                    <div>
                        <a href="{{ route('assessment.show', $evalId) }}"
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                ...
                @if ($canManageAssessment ?? false)
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-primary rounded-pill" id="btn-add-new" data-bs-toggle="modal"
            ...
            <div class="card-body p-0">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-bordered mb-0" id="evidence-table"
                        style="font-size: 0.8rem; table-layout: fixed; width: 100%;">
                        <thead style="background-color: #e9ecef;">
                            <tr>
                                <th class="text-center" style="width: 3%;">No</th>
                                <th style="width: 13%;">Judul</th>
                                <th style="width: 9%;">No. Dokumen</th>
                                <th style="width: 12%;">Ringkasan</th>
                                <th class="text-center" style="width: 5%;">Grup</th>
                                <th style="width: 7%;">Tipe</th>
                                <th style="width: 7%;">Ket. Tipe</th>
                                <th class="text-center" style="width: 5%;">Terbit</th>
                                <th class="text-center" style="width: 5%;">Exp.</th>
                                <th style="width: 9%;">Pemilik</th>
                                <th style="width: 9%;">Pengesahan</th>
                                <th class="text-center" style="width: 7%;">Kls.</th>
                                <th style="width: 4%;">Link</th>
                                <th class="text-center" style="width: 5%;">Aksi</th>
                            </tr>
                            <tr class="table-light">
                                <th></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="judul_dokumen"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="no_dokumen"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="summary"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="grup"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="tipe"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="ket_tipe"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="tahun_terbit"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="tahun_kadaluarsa"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="pemilik_dokumen"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="pengesahan"></th>
                                <th><input type="text" class="form-control form-control-sm px-1 py-0 text-xs"
                                        placeholder="Cari..." data-filter-field="klasifikasi"></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </thead>
                            ...
                            @forelse($evidences as $evidence)
                                <tr>
                                    ...
                                    <td class="text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->no_dokumen ?? '-' }}" data-field="no_dokumen">
                                        {{ $evidence->no_dokumen ?? '-' }}</td>
                                    <td style="word-wrap: break-word; white-space: normal;"
                                        title="{{ $evidence->summary ?? '-' }}" data-field="summary">
                                        {{ $evidence->summary ?? '-' }}</td>
                                    <td class="text-center text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->grup ?? '-' }}" data-field="grup">
                                        {{ $evidence->grup ?? '-' }}</td>
                                    <td class="text-truncate" style="max-width: 0;" title="{{ $evidence->tipe ?? '-' }}"
                                        data-field="tipe">{{ $evidence->tipe ?? '-' }}</td>
                                    <td class="text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->ket_tipe ?? '-' }}" data-field="ket_tipe">
                                        {{ $evidence->ket_tipe ?? '-' }}</td>
                                    <td class="text-center text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->tahun_terbit ?? '-' }}" data-field="tahun_terbit">
                                        {{ $evidence->tahun_terbit ?? '-' }}</td>
                                    <td class="text-center text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->tahun_kadaluarsa ?? '-' }}" data-field="tahun_kadaluarsa">
                                        {{ $evidence->tahun_kadaluarsa ?? '-' }}</td>
                                    <td class="text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->pemilik_dokumen ?? '-' }}" data-field="pemilik_dokumen">
                                        {{ $evidence->pemilik_dokumen ?? '-' }}</td>
                                    <td class="text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->pengesahan ?? '-' }}" data-field="pengesahan">
                                        {{ $evidence->pengesahan ?? '-' }}</td>
                                    <td class="text-center text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->klasifikasi ?? '-' }}" data-field="klasifikasi">
                                        {{ $evidence->klasifikasi ?? '-' }}</td>
                                    <td class="text-center text-truncate" style="max-width: 0;"
                                        title="{{ $evidence->link ? 'Link' : '-' }}">
                                        @if ($evidence->link)
                                            <a href="{{ $evidence->link }}" target="_blank"
                                                class="text-decoration-none shadow-sm"><i class="fas fa-link"></i></a>
                                        @else
                                            -
                                        @endif
                                    </td>
                        ...
                        <nav aria-label="Evidence pagination">
                            <ul class="pagination pagination-sm mb-0">
                                <li class="page-item disabled" id="evidence-prev-item">
                                    <button class="page-link" id="evidence-prev" type="button"><i
                                            class="fas fa-chevron-left"></i></button>
                                </li>
                                <li class="page-item disabled" id="evidence-next-item">
                                    <button class="page-link" id="evidence-next" type="button"><i
        ...
        <!-- Add Evidence Modal -->
        <div class="modal fade" id="addEvidenceModal" tabindex="-1" aria-labelledby="addEvidenceModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addEvidenceForm">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="judul_dokumen" class="form-label">Judul Dokumen <span
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="tahun_kadaluarsa"
                                        name="tahun_kadaluarsa" min="1900" max="2099">
                                </div>
                                <div class="col-md-6">
                                    <label for="pemilik_dokumen" class="form-label">Pemilik Dokumen</label>
                                    <input type="text" class="form-control" id="pemilik_dokumen"
        ...
        <div class="modal fade" id="importEvidenceModal" tabindex="-1" aria-labelledby="importEvidenceModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive" id="import-table-wrapper"
                            style="max-height: 420px; overflow-y: auto;">
                            <table class="table table-sm align-middle" id="import-table">
                                <thead class="align-middle">
                                    <tr>
                                        <th style="width:40px;" class="text-center">
                                            <input type="checkbox" id="import-check-all" class="form-check-input"
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <th><input type="text" class="form-control form-control-sm"
                                                placeholder="Cari ket tipe" data-filter-field="ket_tipe"></th>
                                        <th><input type="text" class="form-control form-control-sm"
                    ...
                    <div class="modal-footer d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-2">
                            <input type="text" class="form-control form-control-sm" id="import-search"
                                placeholder="Cari dokumen..." style="width: 200px;">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <nav aria-label="Import pagination">
                                <ul class="pagination pagination-sm mb-0">
                                    <li class="page-item" id="import-prev-item">
                                        <button class="page-link" id="import-prev" type="button"><i
                                                class="fas fa-chevron-left"></i></button>
                                    </li>
                                    <li class="page-item" id="import-next-item">
                                        <button class="page-link" id="import-next" type="button"><i
                                                class="fas fa-chevron-right"></i></button>
                                    </li>
                                </ul>
                            </nav>
                            ...
                            <button type="button" class="btn btn-primary btn-sm" id="btn-use-imported"
                                disabled>Tambahkan Terpilih</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            window.CURRENT_EVIDENCE_KEYS = @json(
                $evidences->map(function ($item) {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const dom = {
                    ...
                    evidenceTableFilterInputs: Array.from(document.querySelectorAll(
                        '#evidence-table thead input[data-filter-field]')),
                    // Pagination DOM
                ...
                const applyPagination = () => {
                    ...
                    // 2. Paginate
                    const totalPages = Math.max(1, Math.ceil(state.pagination.totalItems / state.pagination
                        .itemsPerPage));
                    ...
                    const startIndex = state.pagination.itemsPerPage === -1 ? 0 : (state.pagination.currentPage -
                        1) * state.pagination.itemsPerPage;
                    let endIndex = state.pagination.itemsPerPage === -1 ? state.pagination.totalItems : startIndex +
            ...
            `;
                ...
                <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.tipe)}" data-field="tipe">${safe(evidence.tipe)}</td>
                <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.ket_tipe)}" data-field="ket_tipe">${safe(evidence.ket_tipe)}</td>
                <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.tahun_terbit)}" data-field="tahun_terbit">${safe(evidence.tahun_terbit)}</td>
                <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.tahun_kadaluarsa)}" data-field="tahun_kadaluarsa">${safe(evidence.tahun_kadaluarsa)}</td>
                <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.pemilik_dokumen)}" data-field="pemilik_dokumen">${safe(evidence.pemilik_dokumen)}</td>
                <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.pengesahan)}" data-field="pengesahan">${safe(evidence.pengesahan)}</td>
                <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.klasifikasi)}" data-field="klasifikasi">${safe(evidence.klasifikasi)}</td>
                <td class="text-center text-truncate" style="max-width: 0;">${linkHtml}</td>
                <td class="text-center px-1">${actionHtml}</td>
            `;
                        dom.evidenceTableBody.appendChild(tr);
                    });
                ...
                const updatePaginationUI = (start, end, total) => {
                    ...
                    if (dom.prevItem) {
                        dom.prevItem.classList.toggle('disabled', state.pagination.currentPage <= 1 || state
                            .pagination.itemsPerPage === -1);
                    }
                    if (dom.nextItem) {
                        dom.nextItem.classList.toggle('disabled', state.pagination.currentPage >= totalPages ||
            ...
            <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.tipe)}">${safe(evidence.tipe)}</td>
            <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.ket_tipe)}">${safe(evidence.ket_tipe)}</td>
            <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.tahun_terbit)}">${safe(evidence.tahun_terbit)}</td>
            <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.tahun_kadaluarsa)}">${safe(evidence.tahun_kadaluarsa)}</td>
            <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.pemilik_dokumen)}">${safe(evidence.pemilik_dokumen)}</td>
            <td class="text-truncate" style="max-width: 0;" title="${safe(evidence.pengesahan)}">${safe(evidence.pengesahan)}</td>
            <td class="text-center text-truncate" style="max-width: 0;" title="${safe(evidence.klasifikasi)}">${safe(evidence.klasifikasi)}</td>
            <td class="text-center text-truncate" style="max-width: 0;">${linkHtml}</td>
            <td class="text-center px-1">${actionHtml}</td>
        `;
                ...
                const handleSaveEvidence = async () => {
                    ...
                    dom.saveEvidenceBtn.innerHTML =
                        '<span class="spinner-border spinner-border-sm me-2"></span>Saving...';

                    try {
                        let url = '{{ route('assessment.evidence.store', $evalId) }}';
                        let method = 'POST';

                        if (state.isEditing && state.currentEvidenceId) {
                            url = `/assessment/evidence/${state.currentEvidenceId}`;
                            method = 'PUT';
                        }
            ...
            `;
                        ...
                        if (!isDuplicate) {
                            ...
                            checkbox.addEventListener('change', (e) => {
                                if (e.target.checked) {
                                    ...
                                    state.selectedImportItemsMap = state.selectedImportItemsMap ||
                                        new Map();
                ...
                const updateImportPaginationUI = () => {
                    const {
                        ...
                        total,
                        perPage
                    } = state.importPagination;

                    if (dom.importPageInfo) {
                        const start = total === 0 ? 0 : (currentPage - 1) * perPage + 1;
                        const end = Math.min(currentPage * perPage, total);
                        dom.importPageInfo.textContent =
                            `Page ${currentPage}/${lastPage} (${start}-${end} of ${total})`;
                    }
                ...
                const loadPreviousEvidences = async () => {
                    ...
                    try {
                        ...
                        const url =
                            `/assessment/{{ $evalId }}/evidence/previous?${params.toString()}`;
                        const response = await fetch(url, {
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')
                                    .getAttribute('content'),
                ...
                if (dom.importModalEl) {
                    dom.importModalEl.addEventListener('show.bs.modal', () => {
                        ...
                        state.importFilters = {};
                        document.querySelectorAll('#import-table thead input[data-filter-field]').forEach(
                            input => {
                                input.value = '';
                            });
                ...
                if (dom.btnUseImported) {
                    dom.btnUseImported.addEventListener('click', async () => {
                        ...
                        const selectedItems = Array.from(state.selectedImportItemsMap ? state
                            .selectedImportItemsMap.values() : []);
                        ...
                        for (const item of selectedItems) {
                            try {
                                const response = await fetch(
                                    `{{ route('assessment.evidence.store', $evalId) }}`, {
                                        method: 'POST',
                                        headers: {
                                            'Content-Type': 'application/json',
                ...
                const bindImportCheckAll = () => {
                    ...
                    dom.importCheckAll.addEventListener('change', (e) => {
                        ...
                        rows.forEach((row) => {
                            ...
                            const item = state.importList.find(i => String(i.id) === String(
                                itemId));
