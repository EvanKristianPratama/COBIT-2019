        ...
        (function() {
            ...
            const ReportApp = {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-1">
                                <a href="/assessment/${Config.routeEvalId}/report-activity/${id}" 
                                   class="btn btn-xs btn-outline-primary rounded-pill py-1 px-3 me-1" 
                                   style="font-size: 0.7rem; font-weight: 600;">
                                    Detail
                                </a>
                                <a href="/assessment/${Config.routeEvalId}/summary/${id}" 
                ...
                <tr class="table-light fw-bold border-top-2">
                    ...
                    <td class="text-center bg-light text-dark">
                        <a href="{{ route('assessment.summary-pdf', ['evalId' => $routeEvalId]) }}" 
