                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="{{ url('/assessment/' . $routeEvalId . '/report-activity/' . $report->objective_id) }}"
                                                class="btn btn-xs btn-outline-primary rounded-pill py-1 px-3 me-1"
                                                style="font-size: 0.7rem; font-weight: 600;">
                                                Detail
                                            </a>
                                            <a href="{{ route('assessment.summary', ['evalId' => $routeEvalId, 'objectiveId' => $report->objective_id]) }}"
