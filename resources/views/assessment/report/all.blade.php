        ...
        <div class="card-header hero-header py-4" style="background:linear-gradient(135deg,#081a3d,#0f2b5c);color:#fff;border:none;">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('assessment.report.spiderweb') }}" class="btn btn-outline-light btn-sm px-3 me-2">
                    ...
                    <a href="{{ route('assessment.index') }}" class="btn btn-light btn-sm rounded-pill px-3">
        ...
        bindEvents() {
            ...
            if (btnExport) {
                btnExport.addEventListener('click', () => {
                    ...
                    form.method = 'POST';
                    form.action = "{{ route('assessment.report.all-pdf') }}";
