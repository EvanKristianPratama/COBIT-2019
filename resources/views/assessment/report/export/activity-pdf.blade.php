    ...
    @if($is_all)
        @foreach($reports as $reportIndex => $report)
            ...
            <div class="header">
                ...
                <div class="header-subtitle">{{ $report['objective']->objective_id }} - {{ $report['objective']->objective }}</div>
            </div>
                ...
                <table>
                    <tr>
                            ...
                            <table style="width: 100%; border-collapse: collapse; border: 1pt solid #000;">
                                <thead>
                                    <tr style="background-color: #9b59b6; color: #fff;">
                                        <th style="width: 25%; font-size: 6pt; border: 0.5pt solid #fff; background-color: #9b59b6; color: #fff; padding: 2px; text-align: center; vertical-align: middle;">{{ $report['objective']->objective_id }}</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="background-color: #fff; color: #000; font-size: 11pt; font-weight: bold; text-align: center; border: 0.5pt solid #000; padding: 4px; vertical-align: middle;">{{ $report['currentLevel'] }}</td>
                                        <td style="background-color: #fff; color: #000; font-size: 11pt; font-weight: bold; text-align: center; border: 0.5pt solid #000; padding: 4px; vertical-align: middle;">{{ $report['ratingString'] }}</td>
                                        <td style="background-color: #fff; color: #000; font-size: 11pt; font-weight: bold; text-align: center; border: 0.5pt solid #000; padding: 4px; vertical-align: middle;">{{ $report['targetLevel'] === null || $report['targetLevel'] === '' ? '-' : $report['targetLevel'] }}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="background-color: #fff; color: #000; font-size: 11pt; font-weight: bold; text-align: center; border: 0.5pt solid #000; padding: 4px; vertical-align: middle;">{{ $report['maxLevel'] }}</td>
                        ...
                        <td style="width: 55%; padding-left: 15px;">
                            ...
                            <div class="info-label">Governance Objective</div>
                            <div style="font-size: 9pt; color: #333;">{{ $report['objective']->objective_id }} - {{ $report['objective']->objective }}</div>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="margin-bottom: 10px; font-weight: bold; font-size: 10pt;">
                ...
                <span style="background-color: #6c757d; color: white; padding: 2px 6px; border-radius: 3px; font-size: 8pt; margin-left: 5px;">
                    {{ count($report['activityData']) }} activities
                </span>
                @if($filterLevel)
            ...
            <table class="activity-table">
                ...
                <tbody>
                    @forelse($report['activityData'] as $index => $activity)
                        <tr>
            ...
            @include('assessment.report.partials.practice-summary', [
                ...
                'practiceSummaryRows' => $report['practiceSummaryRows'],
                'practiceSummaryTotals' => $report['practiceSummaryTotals'],
                'practiceSummaryLevelMetrics' => $report['practiceSummaryLevelMetrics'],
                'practiceSummaryCapability' => $report['practiceSummaryCapability']
            ])
        @endforeach
    @else
        {{-- Header --}}
                        ...
                        <table style="width: 100%; border-collapse: collapse; border: 1pt solid #000;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="background-color: #fff; color: #000; font-size: 11pt; font-weight: bold; text-align: center; border: 0.5pt solid #000; padding: 4px; vertical-align: middle;">{{ $targetLevel === null || $targetLevel === '' ? '-' : $targetLevel }}</td>
                                </tr>
                                <tr>
                                    <td style="background-color: #9b59b6; color: #fff; font-size: 6pt; font-weight: bold; font-style: italic; text-align: center; border: 0.5pt solid #fff; padding: 4px; vertical-align: middle;">Max Level:</td>
