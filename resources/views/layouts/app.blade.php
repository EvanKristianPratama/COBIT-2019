  ...
  <head>
    ...
    <style>
        :root {
            ...
            --navbar-height: 80px; /* Variabel tinggi navbar */
        }
        ...
        /* --- Login Page specific --- */
        body.login { background: var(--cobit-gradient); }
        body.login .breadcrumb-wrapper { display: none; } /* Hide breadcrumb on login */
    </style>
  </head>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto align-items-center">
              ...
              @else
                <li class="nav-item">
                  <a class="nav-link p-0" href="#" role="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarOffcanvas">
                    <div class="d-flex align-items-center gap-3">
                      <div class="d-flex flex-column text-end d-none d-lg-block" style="line-height: 1.2;">
                      ...
                      <div class="d-flex gap-2">
                          ...
                          <span class="user-badge bg-warning text-dark border-0">{{ Auth::user()->jabatan ?? 'Jabatan' }}</span>
                      </div>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel">
          ...
          <div class="offcanvas-body">
            <div class="text-center mb-4">
                <div class="avatar-circle bg-light text-primary mx-auto mb-2 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; border-radius: 50%; font-size: 1.5rem; font-weight: bold;">
