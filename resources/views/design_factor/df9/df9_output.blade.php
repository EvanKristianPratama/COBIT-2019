        ...
        <div class="col-lg-12">
            <div class="card shadow border-0 rounded">
                ...
                <div class="card-header bg-primary text-white text-center py-3">
                    <h4 class="mb-0">Design Factor 9 Output</h4>
                </div>
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($labels as $index => $label)
                                                @php
                                                    // Mengambil nilai score dan relative importance dari data DF9
                                                    $score = $designFactor9->{'s_df9_' . ($index + 1)};
                                                    $relative = $designFactorRelativeImportance->{'r_df9_' . ($index + 1)};
...
document.addEventListener('DOMContentLoaded', function () {
    // Data Relative Importance DF9, diambil dari controller
