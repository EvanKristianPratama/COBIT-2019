        ...
        <div class="col-lg-12">
            <div class="card shadow border-0 rounded">
                ...
                <div class="card-header bg-primary text-white text-center py-3">
                    <h4 class="mb-0">Design Factor 10 Output</h4>
                </div>
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($labels as $index => $label)
                                                @php
                                                    // Mengambil nilai score dan relative importance dari data DF10
                                                    $score = $designFactor10->{'s_df10_' . ($index + 1)};
                                                    $relative = $designFactorRelativeImportance->{'r_df10_' . ($index + 1)};
...
document.addEventListener('DOMContentLoaded', function () {
    // Data Relative Importance DF10, diambil dari controller
