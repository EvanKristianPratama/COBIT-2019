...
const tools = [
    ...
    {
        key: 'Design I&T Tailored Governance System',
        name: 'Design I&T Tailored Governance System',
        description: 'Manajemen tata kelola TI yang disesuaikan',
        url: '/design-toolkit',
    ...
    },
    {
        ...
        description: 'Peta jalan peningkatan kapabilitas TI',
        url: '/roadmap',
