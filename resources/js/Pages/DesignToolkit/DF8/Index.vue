...
<template>
    <AuthenticatedLayout title="DF8 - Sourcing Model for IT">
        <template #header>
            <PageHeader 
                title="Design Factor 8"
                subtitle="Sourcing Model for IT"
                :breadcrumbs="[
                    { label: 'Dashboard', href: routes.dashboard },
                    { label: 'Design Toolkit', href: routes.index },
                    { label: 'DF8 - Sourcing Model for IT' }
                ]"
            />
        </template>
            ...
            <form @submit.prevent="submit">
                ...
                <section class="mb-8">
                    <h2 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">
                        Sourcing Model Distribution
                    </h2>
                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-6">
                        Enter the percentage for each sourcing model.
