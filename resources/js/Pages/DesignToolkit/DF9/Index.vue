...
<template>
    <AuthenticatedLayout title="DF9 - IT Implementation Methods">
        <template #header>
            <PageHeader 
                title="Design Factor 9"
                subtitle="IT Implementation Methods"
                :breadcrumbs="[
                    { label: 'Dashboard', href: routes.dashboard },
                    { label: 'Design Toolkit', href: routes.index },
                    { label: 'DF9 - IT Implementation Methods' }
                ]"
            />
        </template>
            ...
            <form @submit.prevent="submit">
                ...
                <section class="mb-8">
                    <h2 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">
                        IT Implementation Method Distribution
                    </h2>
                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-6">
                        Enter the percentage for each implementation method.
